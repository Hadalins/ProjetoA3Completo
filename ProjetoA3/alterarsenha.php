...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Executa a lógica para atualizar a senha no banco de dados
...
<div class="container">
    ...
    <br>
     ...
     <a href="listar.php">Voltar para Listar Usuários</a>
    <br>
    <a href="logado.php">Voltar para Página inicial</a>
